            ...
            <div className="flex items-center justify-between border-b bg-muted/50 px-3 py-2">
                <div className="flex items-center gap-2">
                    ...
                    <AnimatedTabs
                        ...
                        showContent={false}
                        tabsClassName="flex items-center gap-1 rounded-md bg-background p-1"
                        tabClassName="px-2 py-1 text-xs font-medium rounded-sm transition"
                        activeTabClassName="bg-muted text-foreground"
                        inactiveTabClassName="text-muted-foreground hover:text-foreground"
