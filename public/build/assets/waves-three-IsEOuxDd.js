...
void main() {
	...
	`}var oo=class extends Nt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new pi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `,transparent:!0,depthWrite:!1})}function nl(e,t,n,r){return new Di({uniforms:{uSizeMin:{value:e},uSizeMax:{value:t},uAmp:{value:n},uOpacity:{value:r}},vertexShader:`
            attribute vec3  color;
            varying   vec3  vColor;
        ...
        `,transparent:!0,depthWrite:!1})}function rl(e,t,n,r,i,a){let o=e+1,s=t+1,c=o*s,l=a/2,u=n/e,d=r/t,f=new Float32Array(c*3),p=new Float32Array(c*4*3),m=new Float32Array(c*4*3);for(let e=0;e<s;e++)for(let t=0;t<o;t++){let a=e*o+t,s=-n/2+t*u,h=-r/2+e*d;f[a*3]=s,f[a*3+1]=h,f[a*3+2]=0;let g=a*12;p[g]=s-l,p[g+1]=h,p[g+2]=0,p[g+3]=s+l,p[g+4]=h,p[g+5]=0,p[g+6]=s,p[g+7]=h-l,p[g+8]=0,p[g+9]=s,p[g+10]=h+l,p[g+11]=0;let _=Yc(a/Math.max(c-1,1),i);for(let e=0;e<4;e++)m[g+e*3]=_.r,m[g+e*3+1]=_.g,m[g+e*3+2]=_.b}let h=new fr;return h.setAttribute(`position`,new Z(p,3)),h.setAttribute(`color`,new Z(m,3)),{geo:h,centers:f,pos:p}}function il(e,t,n,r,i,a){let o=e+1,s=t+1,c=Zc(e,t,n,r),l=new Uint32Array(e*t*2),u=0;for(let n=0;n<t;n++)for(let t=0;t<e;t++)a===`right`?(l[u++]=n*o+t,l[u++]=(n+1)*o+t+1):(l[u++]=n*o+t+1,l[u++]=(n+1)*o+t);let d=new fr;return d.setAttribute(`position`,new Z(c,3)),d.setAttribute(`color`,new Z(Xc(o*s,i),3)),d.setIndex(new Z(l,1)),{geo:d,pos:c}}function al(e,t,n,r,i){let a=e+1,o=t+1,s=Zc(e,t,n,r),c=t*e*2,l=new Uint32Array(c*2),u=0;for(let n=0;n<t;n++)for(let t=0;t<e;t++)n%2==0?(l[u++]=n*a+t,l[u++]=(n+1)*a+t+1,l[u++]=n*a+t+1,l[u++]=(n+1)*a+t+1):(l[u++]=n*a+t+1,l[u++]=(n+1)*a+t,l[u++]=n*a+t,l[u++]=(n+1)*a+t);let d=new fr;return d.setAttribute(`position`,new Z(s,3)),d.setAttribute(`color`,new Z(Xc(a*o,i),3)),d.setIndex(new Z(l,1)),{geo:d,pos:s}}function ol(e,t,n,r,i){let a=e,o=t,s=a*o,c=n/a/2,l=c*Math.sqrt(3),u=new Float32Array(s*12*3),d=new Float32Array(s*12*3),f=new Float32Array(s*3),p=0;for(let e=0;e<o;e++)for(let t=0;t<a;t++){let a=t%2==0?0:l*.5,o=-n/2+c+t*c*1.5,m=-r/2+l*.5+e*l+a;f[p*3]=o,f[p*3+1]=m,f[p*3+2]=0;let h=Yc(p/Math.max(s-1,1),i),g=[];for(let e=0;e<6;e++){let t=Math.PI/3*e;g.push([o+c*Math.cos(t),m+c*Math.sin(t)])}for(let e=0;e<6;e++){let t=g[e],n=g[(e+1)%6],r=(p*6+e)*6;u[r]=t[0],u[r+1]=t[1],u[r+2]=0,u[r+3]=n[0],u[r+4]=n[1],u[r+5]=0;for(let e=0;e<2;e++)d[r+e*3]=h.r,d[r+e*3+1]=h.g,d[r+e*3+2]=h.b}p++}let m=new fr;return m.setAttribute(`position`,new Z(u.slice(0,p*6*6),3)),m.setAttribute(`color`,new Z(d.slice(0,p*6*6),3)),{geo:m,pos:u,hexCenters:f.slice(0,p*3)}}function sl(e,t,n,r,i,a,o){let s=e+1,c=t+1,l=n/e,u=r/t,d=o/2,f=((a===`vertical`?0:c*e)+(a===`horizontal`?0:s*t))*2,p=new Float32Array(f*3),m=new Float32Array(f*3),h=new Float32Array(f*3),g=0;Zc(e,t,n,r),Xc(s*c,i);let _=(e,t,n,r,a)=>{let o=Yc(a/Math.max(s*c-1,1),i);for(let i=0;i<2;i++){let[a,s]=i===0?[e,t]:[n,r];p[g*3]=a,p[g*3+1]=s,p[g*3+2]=0,m[g*3]=a,m[g*3+1]=s,m[g*3+2]=0,h[g*3]=o.r,h[g*3+1]=o.g,h[g*3+2]=o.b,g++}};if(a!==`vertical`)for(let t=0;t<c;t++)for(let i=0;i<e;i++){let e=-n/2+i*l,a=e+l,o=-r/2+t*u;_(e+l*d,o,a-l*d,o,t*s+i)}if(a!==`horizontal`)for(let e=0;e<s;e++)for(let i=0;i<t;i++){let t=-r/2+i*u,a=t+u,o=-n/2+e*l;_(o,t+u*d,o,a-u*d,i*s+e)}let v=new fr;return v.setAttribute(`position`,new Z(p,3)),v.setAttribute(`color`,new Z(h,3)),{geo:v,pos:p,basePos:m}}function cl(e,t,n,r,i,a){let o=e*t*4*2,s=new Float32Array(o*3),c=new Float32Array(o*3),l=new fr;return l.setAttribute(`position`,new Z(s,3).setUsage(Ke)),l.setAttribute(`color`,new Z(c,3).setUsage(Ke)),l.setDrawRange(0,0),{geo:l,vtxGrid:Zc(e,t,n,r)}}function ll(e,t,n,r,i){let a=new vi(n,r,e,t),o=a.attributes.position.count;return a.setAttribute(`color`,new Z(Xc(o,i),3)),{geo:a,pos:a.attributes.position.array}}var ul=e=>{let t=(0,o.c)(68),{className:n,style:r,lines:s,colors:c,cameraPosition:l,planeWidth:u,planeHeight:d,segmentsX:f,segmentsY:p,speed:m,amplitude:h,frequency:g,opacity:_,paused:v,mouseInfluence:y,mouseRotation:b,dotSize:x,dotSizeMin:S,crossSize:C,dashRatio:w,contourLevels:T,maxPixelRatio:E,onReady:D}=e,O=r===void 0?`grid`:r,k=s===void 0?`both`:s,A;t[0]===l?A=t[1]:(A=l===void 0?{x:0,y:0,z:10}:l,t[0]=l,t[1]=A);let j=A,M=u===void 0?80:u,N=d===void 0?40:d,ee=f===void 0?60:f,te=p===void 0?30:p,P=m===void 0?1:m,ne=h===void 0?1.5:h,re=g===void 0?.3:g,ie=_===void 0?.6:_,ae=v===void 0?!1:v,F=y===void 0?2:y,oe=b===void 0?.1:b,se=x===void 0?3:x,I=S===void 0?1:S,ce=C===void 0?.3:C,le=w===void 0?.5:w,ue=T===void 0?6:T,de=E===void 0?2:E,fe=(0,a.useRef)(null),pe;t[2]===Symbol.for(`react.memo_cache_sentinel`)?(pe={width:0,height:0},t[2]=pe):pe=t[2];let[L,me]=(0,a.useState)(pe),he;t[3]===Symbol.for(`react.memo_cache_sentinel`)?(he={x:0,y:0},t[3]=he):he=t[3];let ge=(0,a.useRef)(he),_e=(0,a.useRef)(P),ve=(0,a.useRef)(ae),ye=(0,a.useRef)(ne),be=(0,a.useRef)(re),xe=(0,a.useRef)(F),Se=(0,a.useRef)(oe),Ce=(0,a.useRef)(ie),we,Te;t[4]===P?(we=t[5],Te=t[6]):(we=()=>{_e.current=P},Te=[P],t[4]=P,t[5]=we,t[6]=Te),(0,a.useEffect)(we,Te);let Ee,De;t[7]===ae?(Ee=t[8],De=t[9]):(Ee=()=>{ve.current=ae},De=[ae],t[7]=ae,t[8]=Ee,t[9]=De),(0,a.useEffect)(Ee,De);let R,Oe;t[10]===ne?(R=t[11],Oe=t[12]):(R=()=>{ye.current=ne},Oe=[ne],t[10]=ne,t[11]=R,t[12]=Oe),(0,a.useEffect)(R,Oe);let z,ke;t[13]===re?(z=t[14],ke=t[15]):(z=()=>{be.current=re},ke=[re],t[13]=re,t[14]=z,t[15]=ke),(0,a.useEffect)(z,ke);let B,Ae;t[16]===F?(B=t[17],Ae=t[18]):(B=()=>{xe.current=F},Ae=[F],t[16]=F,t[17]=B,t[18]=Ae),(0,a.useEffect)(B,Ae);let V,H;t[19]===oe?(V=t[20],H=t[21]):(V=()=>{Se.current=oe},H=[oe],t[19]=oe,t[20]=V,t[21]=H),(0,a.useEffect)(V,H);let je,Me;t[22]===ie?(je=t[23],Me=t[24]):(je=()=>{Ce.current=ie},Me=[ie],t[22]=ie,t[23]=je,t[24]=Me),(0,a.useEffect)(je,Me);let Ne,Pe;t[25]===Symbol.for(`react.memo_cache_sentinel`)?(Ne=()=>{let e=fe.current;if(!e)return;let t=new ResizeObserver(e=>{let t=e[0].contentRect;me({width:t.width,height:t.height})});return t.observe(e),()=>t.disconnect()},Pe=[],t[25]=Ne,t[26]=Pe):(Ne=t[25],Pe=t[26]),(0,a.useEffect)(Ne,Pe);let Fe;t[27]!==ne||t[28]!==j||t[29]!==c||t[30]!==ue||t[31]!==ce||t[32]!==le||t[33]!==se||t[34]!==I||t[35]!==k||t[36]!==de||t[37]!==D||t[38]!==N||t[39]!==M||t[40]!==ee||t[41]!==te||t[42]!==L.height||t[43]!==L.width||t[44]!==O?(Fe=()=>{let e=fe.current;if(!e||L.width===0||L.height===0)return;let t=new yn,n=new oa(75,L.width/L.height,.1,1e3);n.position.set(j.x,j.y,j.z),n.lookAt(0,0,0);let r=new Gc({alpha:!0,antialias:!0});r.setPixelRatio(Math.min(window.devicePixelRatio,de)),r.setSize(L.width,L.height),r.setClearColor(0,0),e.appendChild(r.domElement);let i=document.documentElement.classList.contains(`dark`),a=(c??(i?Jc:qc)).map(dl),o,s,l,u=null,d=null,f=null,p=null,m=null,h=null,g=null,_=[],v=[],y=ee,b=te;if(O===`wireframe`){let e=new vi(M,N,y,b);e.setAttribute(`color`,new Z(Xc(e.attributes.position.count,a),3));let t=new Cr({vertexColors:!0,wireframe:!0,transparent:!0,opacity:Ce.current});o=new Fr(e,t),f=e.attributes.position,u=f.array,s=e,l=t}else if(O===`grid`){let{geo:e,pos:t}=$c(y,b,M,N,a,k),n=new qr({vertexColors:!0,transparent:!0,opacity:Ce.current});o=new ai(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(O===`dots`){let{geo:e,pos:t}=el(y,b,M,N,a),n=tl(se*2,Ce.current);o=new di(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(O===`dots-wave`){let{geo:e,pos:t}=el(y,b,M,N,a),n=nl(I*2,se*2,ne,Ce.current);o=new di(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(O===`crosses`){let{geo:e,centers:t,pos:n}=rl(y,b,M,N,a,ce),r=new qr({vertexColors:!0,transparent:!0,opacity:Ce.current});o=new ai(e,r),f=e.attributes.position,u=n,p=t,s=e,l=r}else if(O===`diagonal-left`||O===`diagonal-right`){let{geo:e,pos:t}=il(y,b,M,N,a,O===`diagonal-left`?`left`:`right`),n=new qr({vertexColors:!0,transparent:!0,opacity:Ce.current});o=new ai(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(O===`zigzag`){let{geo:e,pos:t}=al(y,b,M,N,a),n=new qr({vertexColors:!0,transparent:!0,opacity:Ce.current});o=new ai(e,n),f=e.attributes.position,u=t,s=e,l=n}else if(O===`hexagons`){let{geo:e,pos:t,hexCenters:n}=ol(y,b,M,N,a),r=new qr({vertexColors:!0,transparent:!0,opacity:Ce.current});o=new ai(e,r),f=e.attributes.position,h=t,m=n,s=e,l=r}else if(O===`dashes`){let{geo:e,pos:t,basePos:n}=sl(y,b,M,N,a,k,le),r=new qr({vertexColors:!0,transparent:!0,opacity:Ce.current});o=new ai(e,r),f=e.attributes.position,u=t,d=n,s=e,l=r}else if(O===`contour`){let{geo:e,vtxGrid:t}=cl(y,b,M,N,a,ue),n=new qr({vertexColors:!0,transparent:!0,opacity:Ce.current});o=new ai(e,n),f=e.attributes.position,g=t,s=e,l=n}else{let{geo:e,pos:n}=ll(y,b,M,N,a),r=new ki({vertexColors:!0,transparent:!0,opacity:Ce.current,side:2,shininess:60}),i=new la(16777215,1.2);i.position.set(5,10,7);let c=new ua(16777215,.4);t.add(i,c),v=[i,c],o=new Fr(e,r),f=e.attributes.position,u=n,s=e,l=r}t.add(o);let x=()=>{n.aspect=e.clientWidth/e.clientHeight,n.updateProjectionMatrix(),r.setSize(e.clientWidth,e.clientHeight)},S=e=>{ge.current.x=e.clientX/window.innerWidth*2-1,ge.current.y=-(e.clientY/window.innerHeight)*2+1};window.addEventListener(`resize`,x),window.addEventListener(`mousemove`,S);let C=(e,t,n,r,i)=>{let s=y+1,c=0,l=r.array,u=i.array;for(let r of n){let n=Yc((r-(-ne-1))/((ne+1)*2),a);for(let i=0;i<b;i++)for(let a=0;a<y;a++){let o=i*s+a,d=i*s+a+1,f=(i+1)*s+a,p=(i+1)*s+a+1,m=t[o],h=t[d],g=t[f],_=t[p],v=e[o*3],y=e[o*3+1],b=e[d*3],x=e[d*3+1],S=e[f*3],C=e[f*3+1],w=e[p*3],T=e[p*3+1],E=[],D=(e,t,n,i,a,o,s,c)=>{if(e<r!=t<r){let a=(r-e)/(t-e);E.push([n+(o-n)*a,i+(s-i)*a,r])}};if(D(m,h,v,y,m,b,x,h),D(h,_,b,x,h,w,T,_),D(g,_,S,C,g,w,T,_),D(m,g,v,y,m,S,C,g),E.length>=2&&c+6<=l.length)for(let e=0;e<2;e++)l[c]=E[e][0],l[c+1]=E[e][1],l[c+2]=E[e][2],u[c]=n.r,u[c+1]=n.g,u[c+2]=n.b,c+=3}}r.needsUpdate=!0,i.needsUpdate=!0,o.geometry.setDrawRange(0,c/3)},w=O===`contour`?new Float32Array((y+1)*(b+1)):null,T,E=()=>{if(T=requestAnimationFrame(E),l.opacity!==void 0&&(l.opacity=Ce.current),l.uniforms?.uOpacity&&(l.uniforms.uOpacity.value=Ce.current),!ve.current){let e=performance.now()*.001*_e.current,t=be.current,n=ye.current,r=xe.current,i=ge.current.x,a=ge.current.y;if(O===`crosses`&&p&&f&&u){let o=(y+1)*(b+1);for(let s=0;s<o;s++){let o=p[s*3],c=p[s*3+1],l=Qc(o,c,e,t,n,i,a,r),d=s*12;u[d+2]=l,u[d+5]=l,u[d+8]=l,u[d+11]=l}f.needsUpdate=!0}else if(O===`hexagons`&&m&&h&&f){let o=m.length/3;for(let s=0;s<o;s++){let o=m[s*3],c=m[s*3+1],l=Qc(o,c,e,t,n,i,a,r),u=s*6*6;for(let e=0;e<12;e++)h[u+e*3+2]=l}let c=s.attributes.position,l=c.array;l.set(h.slice(0,l.length)),c.needsUpdate=!0}else if(O===`dashes`&&u&&d&&f){let o=u.length/3;for(let s=0;s<o;s++){let o=d[s*3],c=d[s*3+1];u[s*3+2]=Qc(o,c,e,t,n,i,a,r)}f.needsUpdate=!0}else if(O===`contour`&&g&&w&&f){let o=(y+1)*(b+1);for(let s=0;s<o;s++){let o=g[s*3],c=g[s*3+1];w[s]=Qc(o,c,e,t,n,i,a,r)}let c=[];for(let e=0;e<ue;e++)c.push(-n-1+e/(ue-1)*(n+1)*2);C(g,w,c,s.attributes.position,s.attributes.color)}else if(u&&f){let o=u.length/3;for(let s=0;s<o;s++){let o=u[s*3],c=u[s*3+1];u[s*3+2]=Qc(o,c,e,t,n,i,a,r)}f.needsUpdate=!0,O===`solid`&&s.computeVertexNormals()}o.rotation.x=a*Se.current,o.rotation.y=i*Se.current}r.render(t,n)};return E(),D?.(),()=>{cancelAnimationFrame(T),window.removeEventListener(`resize`,x),window.removeEventListener(`mousemove`,S),v.forEach(e=>t.remove(e)),t.remove(o),s.dispose(),l.dispose(),_.forEach(fl),r.dispose(),e.contains(r.domElement)&&e.removeChild(r.domElement)}},t[27]=ne,t[28]=j,t[29]=c,t[30]=ue,t[31]=ce,t[32]=le,t[33]=se,t[34]=I,t[35]=k,t[36]=de,t[37]=D,t[38]=N,t[39]=M,t[40]=ee,t[41]=te,t[42]=L.height,t[43]=L.width,t[44]=O,t[45]=Fe):Fe=t[45];let Ie;t[46]!==j||t[47]!==c||t[48]!==ue||t[49]!==ce||t[50]!==le||t[51]!==se||t[52]!==I||t[53]!==k||t[54]!==de||t[55]!==D||t[56]!==N||t[57]!==M||t[58]!==ee||t[59]!==te||t[60]!==L.height||t[61]!==L.width||t[62]!==O?(Ie=[L.width,L.height,O,c,k,j,M,N,ee,te,se,I,ce,le,ue,de,D],t[46]=j,t[47]=c,t[48]=ue,t[49]=ce,t[50]=le,t[51]=se,t[52]=I,t[53]=k,t[54]=de,t[55]=D,t[56]=N,t[57]=M,t[58]=ee,t[59]=te,t[60]=L.height,t[61]=L.width,t[62]=O,t[63]=Ie):Ie=t[63],(0,a.useEffect)(Fe,Ie);let Le;t[64]===n?Le=t[65]:(Le=i(`pointer-events-none absolute inset-0`,n),t[64]=n,t[65]=Le);let Re;return t[66]===Le?Re=t[67]:(Re=(0,Kc.jsx)(`div`,{ref:fe,className:Le,"aria-hidden":`true`}),t[66]=Le,t[67]=Re),Re};function dl(e){return new X(e)}function fl(e){return e.dispose()}export{ul as t};